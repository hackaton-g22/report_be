...
class Desaparecido(models.Model):
    ...
    des_cedula = models.DecimalField(max_length=20, max_digits=9, decimal_places=2)
    ...
    fam_telefono = models.DecimalField(max_length= 20, max_digits=9, decimal_places=2)
